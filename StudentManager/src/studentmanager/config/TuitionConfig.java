...
public class TuitionConfig {
    ...
    public static final int RES_TUITION = 12536;
    public static final int RES_TUITION_PER_CREDIT = 404;
    public static final int RES_DEFAULT_FIN_AID_AMOUNT = 0;
    public static final int RES_UNI_FEE = 3268;
